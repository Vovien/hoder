...
import com.holderzone.intelligencepos.widget.recyclerview.base.ItemViewDelegateManager;
        ...
        viewHolder.getConvertView().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mOnItemClickListener != null) {
                    int position = viewHolder.getLayoutPosition();// 不要使用getAdapterPosition会出现index==-1的情况
