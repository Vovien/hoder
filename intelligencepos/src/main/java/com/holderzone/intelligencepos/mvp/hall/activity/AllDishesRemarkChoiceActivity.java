...
import com.holderzone.intelligencepos.mvp.hall.presenter.AllDishesRemarkChoicePresenter;
 ...
 */
public class AllDishesRemarkChoiceActivity extends BaseActivity<AllDishesRemarkChoiceContract.Presenter> implements AllDishesRemarkChoiceContract.View {
    ...
    public static Intent newIntent(Context context, List<SalesOrderBatchDishesE> mOrderDishesList, boolean isUseMemberPrice) {
        Intent intent = new Intent(context, AllDishesRemarkChoiceActivity.class);
    ...
    @Nullable
    @Override
    protected AllDishesRemarkChoiceContract.Presenter initPresenter() {
        return new AllDishesRemarkChoicePresenter(this);
    }
