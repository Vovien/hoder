package com.holderzone.intelligencepos.mvp.snack.presenter;
...
public class SnackAllDishesRemarkChoicePresenter extends BasePresenter<SnackAllDishesRemarkChoiceContract.View> implements SnackAllDishesRemarkChoiceContract.Presenter {
    public SnackAllDishesRemarkChoicePresenter(SnackAllDishesRemarkChoiceContract.View view) {
        super(view);
