 ...
 */
package com.holderzone.intelligencepos.adapter.base;
...
public abstract class SectionedRecyclerViewAdapter<H extends RecyclerView.ViewHolder,
        ...
        if (isSectionHeaderPosition(position)) {
            ...
            if (onHeaderClickListener != null) {
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        onHeaderClickListener.onHeaderClick(holder.itemView, section);
                        Log.e("section", "section:" + section + ";index:" + index);
                    }
                });
            }
            ...
            if (onItemClickListener != null) {
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        onItemClickListener.onItemClick(holder.itemView, section, index);
                    }
                });
            }
        }
    ...
    public interface OnItemClickListener {
        void onItemClick(View view, int section, int index);
    }

    public interface OnHeaderClickListener {
        void onHeaderClick(View view, int section);
    }
